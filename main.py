...
def start(client, message):
    kb = [[InlineKeyboardButton('Kanal 🛡', url=chnnl),InlineKeyboardButton('İnstagram 🔰', url="https://instagram.com/kenanbabayevofficial/")]]
    reply_markup = InlineKeyboardMarkup(kb)
    app.send_message(chat_id=message.from_user.id, text=f"Salam xoş gəldiniz**TikTok Aze Video Yukleme Bot**.\nI vastəsi ilə siz tiktok videolarını logosuz yükləyə bilərsiz.\n\n"
                          "__**Developer :**__ __@kenanbabayevofficial__\n"
